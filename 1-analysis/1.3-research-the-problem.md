...
Undertale is a top down 2D RPG video game created by Toby Fox in 2015. The game involves a unique mechanic of players either being able to play as a pacifist without engaging in combat or fighting all or every NPC.&#x20;

### Controls

![U](<../.gitbook/assets/image (8) (1).png>)

With Undertales main platform being the PC the controls consist of the arrow keys to move around or the Z, X or C keys to interact with objects and dialogue. <img src="../.gitbook/assets/image (9).png" alt="" data-size="original">
